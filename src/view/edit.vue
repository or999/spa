<template>
  <div class="edit">
    ...
    <el-form-item label="在线状态:">
      <el-switch v-model="product.online" active-text="在线"
  inactive-text="下线"
  ></el-switch>
    </el-form-item>
    <el-form-item label="开关状态 :">
      <el-switch v-model="product.status" active-text="ON"
  inactive-text="OFF"
  ></el-switch>
    </el-form-item>
...
export default {
  ...
  methods: {
    ...
    let {id,type,name,address,
    online,status,brightness,voltage,
    electric,activePower,powerFactor,
    workTime,hz}=products[0]
    this.product = {id,type,name,address,
    online,status,brightness,voltage,
    electric,activePower,powerFactor,
    workTime,hz}
    },
